...
В английском поры года имеют следующие наименования: весна — spring, лето — getSumOfDigits, осень — autumn (fall), зима — winter.
...
### **Преобразование массива**function calculateHanoi(disksNumber, turnsSpeed) {
